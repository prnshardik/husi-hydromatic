                    ...
                    <form name="form" id="form" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-12">
                                ...
                                <textarea name="description" id="description" class="form-control" placeholder="Plese enter description" cols="3" rows="5" disabled>{{ @old('description', $data->description) }}</textarea>
                                <span class="kt-form__help error description"></span>
                            </div>

                            <div class="form-group col-sm-12">
                                <label for="image">Image</label>
                                <input type="file" class=" dropify disabled" disabled id="image" name="image"  data-allowed-file-extensions="jpg png jpeg" data-default-file="{{ $data->image }}" data-max-file-size-preview="20M" data-show-remove="true">
