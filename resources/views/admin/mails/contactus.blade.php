                                                        ...
                                                        <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                                            <tr>
                                                                <td class="attributes_item">
                                                                    <span class="f-fallback">Name: {{ $data['name'] ?? '' }}</span>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="attributes_item">
                                                                    <span class="f-fallback">Email: {{ $data['email'] ?? '' }}</span>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="attributes_item">
                                                                    <span class="f-fallback">Phone: {{ $data['phone'] ?? '' }}</span>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="attributes_item">
                                                                    <span class="f-fallback">Message: {{ $data['message'] ?? '' }}</span>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
